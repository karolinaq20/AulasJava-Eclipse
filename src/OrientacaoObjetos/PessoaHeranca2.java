...
public class PessoaHeranca2 extends PessoaHeranca{

	private int codigoSetor;
	private float salarioBase;
	private float imposto;
	
	public PessoaHeranca2(String nome,String endereco,String cpf,int telefone,int idade,int codigoSetor,float salarioBase,float imposto)
	{
